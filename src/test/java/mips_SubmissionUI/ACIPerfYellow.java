...
public class ACIPerfYellow extends Base {
    ...
    @Test
    public void aciPerformanceYellow() {
        ...
        try {
            Assert.assertEquals(ac.getPerfYellow().getText(), "You will be unable to choose a track until a performance period date range is entered above .");
            Log.info("The page contains the ACI Performance Period Yellow Banner");

        } catch (Exception e) {
            Log.error("The page doesn't contains the ACI Performance Period Yellow Banner");
        }
