...
public class IAread extends Base{
    ...
    @Test
    public void iaReadInstructions() throws InterruptedException {
        ...
        Thread.sleep(1000);
        ia.openFullInstructions().click();
        Log.info("Opening the IA Full Instructions");

        //Verify the text "Improvement Activities" presented in the Full Instructions Model
        Thread.sleep(1000);

        try {
            Assert.assertEquals(ia.titleFullInstructions().getText(), "Improvement Activities Instructions");
            Log.info("The page contains the text Improvement Activities");

        } catch (Exception f) {
            Log.error("The page doesn't contains the Improvement Activities");
        }

        // Close Full Instruction window
        Thread.sleep(1000);
        ia.closeFullInstructions().click();
        Log.info("Closing the IA Full Instructions");
