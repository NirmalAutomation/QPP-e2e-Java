...
public class ACIBonusAttestation extends Base {
    ...
    @Test(priority = 0)
    public void aciBonusHeaderPopup() throws InterruptedException {

        // ACI Page displayed
        F_ACIPage ac = new F_ACIPage(driver);
        Log.info("ACI Page displayed");

        // ACI Bonus Measure help popup
        Thread.sleep(1000);
        ac.getBonusPopup().click();
    ...
    @Test(priority = 1)
    public void aciBonusAttestation() throws InterruptedException {

        // ACI Page displayed
        F_ACIPage ac = new F_ACIPage(driver);
        Log.info("ACI Page displayed");

        //  Syndromic Surveillance Reporting ACI_TRANS_PHCDRR_2
        ac.getYesACI_TRANS_PHCDRR_2().click();
        Log.info("Click action 'Yes' radio button for Syndromic Surveillance Reporting ACI_TRANS_PHCDRR_2");

        //  Specialized Registry Reporting ACI_TRANS_PHCDRR_3
        ac.getYesACI_TRANS_PHCDRR_3().click();
        Log.info("Click action 'Yes' radio button for Specialized Registry Reporting ACI_TRANS_PHCDRR_3");
    }
