...
public class ACICEHRTAttestation extends Base {
    ...
    public void aciBonusHeaderPopup() throws InterruptedException {
        ...
        // ACI CEHRT Measure help popup
        Thread.sleep(1000);
        ac.getACICEHRTPopup().click();
        Log.info("Click action on CEHRT help icon");
    ...
    public void aciBonusAttestation() throws InterruptedException {
        ...
        // CEHRT Used ACI_IACEHRT_1
        ac.getYesACI_IACEHRT_1().click();
        Log.info("Click action 'Yes' radio button for CEHRT Used ACI_IACEHRT_1");

        // CEHRT Confirm popup
        Thread.sleep(1000);
        ac.getContinueCEHRTPopup().click();
        Log.info("Click action on CEHRT Popup Continue button");
