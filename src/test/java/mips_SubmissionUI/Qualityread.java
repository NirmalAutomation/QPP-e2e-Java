...
public class Qualityread extends Base{
    ...
    @Test
    public void qualityReadInstructions() throws InterruptedException {
        ...
        Thread.sleep(1000);
        q.openFullInstructions().click();
        Log.info("Opening the Quality Full Instructions");

        //Verify the text "Quality Instructions" presented in the Full Instructions Model
        Thread.sleep(1000);

        try {
            Assert.assertEquals(q.titleFullInstructions().getText(), "Quality Instructions");
            Log.info("The page contains the text Quality Instructions");

        } catch (Exception j) {
            Log.error("The page doesn't contains the text Quality Instructions");
        }

        // Close Full Instruction window
        Thread.sleep(1000);
        q.closeFullInstructions().click();
        Log.info("Closing the Quality Full Instructions");
